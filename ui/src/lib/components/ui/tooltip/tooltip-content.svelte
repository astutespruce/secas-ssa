	...
	>
		...
		<TooltipPrimitive.Arrow>
			{#snippet child({ props })}
				<div
					class={cn(
						'bg-grey-8 z-50 size-4 [clip-path:polygon(100%_100%,100%_0%,0%_100%,10%_100%)] rotate-45 rounded-[2px]',
						'data-[side=top]:translate-x-1/2 data-[side=top]:translate-y-[calc(-50%_+_2px)]',
						'data-[side=bottom]:-translate-x-1/2 data-[side=bottom]:-translate-y-[calc(-50%_+_1px)]',
						'data-[side=right]:translate-x-[calc(50%_+_3px)] data-[side=right]:translate-y-1/2',
